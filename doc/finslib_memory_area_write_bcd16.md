...
The function `finslib_memory_area_write_bcd16()` can be used to write a block of 16 bit unsigned BCD values to a memory
...
Existence and filling of the dataspace is the responsibility of the calling function, but `finslib_memory_area_write_bcd16()`
...
`finslib_memory_area_write_bcd16()` will automatically use multiple request at the FINS layer if the dataset is 
too large.
