...
Enough dataspace is the responsibility of the calling function, but `finslib_memory_area_read_uint32()`
...
`finslib_memory_area_read_uint32()` will automatically use multiple request at the FINS layer if the dataset will
be too large.
